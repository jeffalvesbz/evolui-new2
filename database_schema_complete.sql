...
CREATE TABLE IF NOT EXISTS revisoes (
    ...
    data_conclusao TIMESTAMPTZ, -- Data e hora em que a revisão foi concluída
...
COMMENT ON COLUMN revisoes.data_conclusao IS 'Data e hora em que a revisão foi concluída';
