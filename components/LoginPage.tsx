          ...
          {authMode !== 'forgot' && (
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full h-11 px-4 flex items-center justify-center gap-3 rounded-lg bg-background border border-border hover:bg-muted/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-background border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full pl-10 pr-12 py-2.5 bg-background border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                    />
                    <button
                      type="button"
                ...
                {!emailSent ? (
                  <>
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="flex-1 h-11 px-4 flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-black text-sm font-semibold hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-primary/20"
                      >
                        {loading ? (
                          <>
                            <div className="w-4 h-4 border-2 border-black/20 border-t-black rounded-full animate-spin"></div>
                  ...
                  <div className="text-center space-y-4 py-4">
                    ...
                    <button
                      ...
                      className="w-full h-11 px-4 flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-black text-sm font-semibold hover:opacity-90 transition-all shadow-lg shadow-primary/20"
                    >
                      Voltar ao login
                    </button>
                  </div>
