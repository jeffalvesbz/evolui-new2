...
const commandItems: CommandItem[] = [
  ...
  { id: 'gamificacao', label: 'Jornada do Herói', icon: <TrophyIcon />, category: 'Ferramentas', description: 'Gamificação e conquistas' },
];
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <Command className="bg-card border border-white/10 rounded-lg shadow-2xl overflow-hidden">
