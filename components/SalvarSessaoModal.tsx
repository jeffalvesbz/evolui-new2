...
const SalvarSessaoModal: React.FC = () => {
    ...
    const questoesCertas = watch('questoesCertas') || 0;
    const questoesErradas = watch('questoesErradas') || 0;
    ...
    const onSubmit = async (data: SalvarSessaoFormData) => {
        ...
        try {
            ...
            await salvarSessao({
                ...
                questoes_certas: (data.categoria === 'Questões' || data.categoria === 'Simulado') ? Number(data.questoesCertas) : undefined,
            ...
            console.error(error);
            toast.error("Erro ao salvar o estudo.");
        } finally {
